...
> 作者：Yuimi-chaya。来源：[原文](https://github.com/Yuimi-chaya/Yuimi-chaya.github.io/blob/4fd072b8efb10e34403037d6fda2f068d1acd934/src/content/blog/astrbot-roleplay-persona-notes.md)。
>
> 本地阅读副本：保留正文；移除站点 frontmatter 和封面引用，补回标题，转换站点专用代码块、图文容器与站内链接，图片改为仓库内相对路径。其中气泡配额、正反例优劣、模型“路由”解释及效果归因属于当时的经验表述，不是本书统一结论；请结合[阅读说明](README.md)与[人设章](../chapters/05-persona.md)阅读。
>
