...
| OneBot 私聊输入状态 | [`5efb843` 源码](https://github.com/ctrlkk/astrbot_plugin_input_state_by_nc/blob/5efb843aaaa2280c24e4874de086ddad31cbe3b4/main.py) | AstrBot OneBot 私聊事件、`set_input_status` 扩展动作、LLM 请求钩子与超时 |
